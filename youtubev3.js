...
function loadVideo(keyword) {
    var YOUBE_API="https://content.googleapis.com/youtube/v3/search?q=" + keyword + "&type=video&maxResults=9&part=snippet&key=AIzaSyClsArH5rhCEFAD30ZezSnI4fl_9rpabCA";
    var xhr = new XMLHttpRequest();
    xhr.open("GET", YOUBE_API, true);
